...
export default class RightHands {
    ...
    update() {
        this.hand1.rotation.x = -this.world.rotor.model.rotation.x + this.addHandRotation
        this.hand2.rotation.x = -this.world.rotor.model.rotation.x + this.addHandRotation
